...
### Shows all category budgets: `listBgt`
...
### Shows all used categories in order of appearance: `listCat`
...
### Shows overall expense or expense for a specific category: `check`
...
### Clear all entries in money list: `clear`
